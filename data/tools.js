...
const TOOLS = [
  ...
  { id: 'wordcount', name: '字数统计', category: 'text', icon: '📝', path: '/packages/toolsA/wordcount/index', description: '字符/字数/行数统计' },
  ...
  { id: 'randomgroup', name: '随机分组', category: 'fun', icon: '👥', path: '/packages/moreTools/randomgroup/index', description: '名单随机分组' },
  { id: 'sketch', name: '简易画板', category: 'image', icon: '✏️', path: '/packages/imgTools/sketch/index', description: '涂鸦/签名画板' },
  { id: 'math24', name: '数学训练', category: 'fun', icon: '🧮', path: '/packages/moreTools/math24/index', description: '24点计算挑战' },
  { id: 'sudoku', name: '逻辑推理', category: 'fun', icon: '🔢', path: '/packages/moreTools/sudoku/index', description: '数独逻辑训练' },
  { id: 'klotski', name: '拼图益智', category: 'fun', icon: '🧩', path: '/packages/moreTools/klotski/index', description: '数字滑块拼图' },
  { id: 'maze', name: '专注力训练', category: 'fun', icon: '🌀', path: '/packages/moreTools/maze/index', description: '迷宫寻路挑战' },
  { id: 'colorchallenge', name: '色感测试', category: 'fun', icon: '🎨', path: '/packages/moreTools/colorchallenge/index', description: '色彩敏感度挑战' },
  ...
  { id: 'urlencode', name: 'URL编解码', category: 'text', icon: '🔗', path: '/packages/moreTools/urlencode/index', description: 'URL编码/解码转换' },
  { id: 'age', name: '年龄生肖', category: 'life', icon: '🎂', path: '/packages/calcTools/age/index', description: '年龄·生肖·星座计算' },
  ...
  { id: 'kinship', name: '亲戚称呼', category: 'life', icon: '👨‍👩‍👧‍👦', path: '/packages/calcTools/kinship/index', description: '亲戚关系称呼速查' },
  ...
  { id: 'flashlight', name: '手电筒', category: 'life', icon: '🔦', path: '/packages/calcTools/flashlight/index', description: '一键开启闪光灯照明' },
  { id: 'watermark', name: '水印相机', category: 'image', icon: '📸', path: '/packages/imgTools/watermark/index', description: '拍照添加时间地点水印' },
  { id: 'scicalc', name: '科学计算器', category: 'life', icon: '🔬', path: '/packages/calcTools/scicalc/index', description: '科学计算·三角函数·对数' },
  { id: 'todolist', name: '待办清单', category: 'life', icon: '📝', path: '/packages/toolsA/todolist/index', description: '任务管理·优先级·进度追踪' },
  ...
  { id: 'neontext', name: '流光文字', category: 'fun', icon: '✨', path: '/packages/toolsB/neontext/index', description: '霓虹流光动画文字效果' },
  { id: 'poetrygame', name: '诗词飞花令', category: 'text', icon: '🏮', path: '/packages/moreTools/poetrygame/index', description: '选字列出经典诗句·挑战模式' },
  { id: 'dailyquote', name: '人生格言', category: 'fun', icon: '💬', path: '/packages/toolsA/dailyquote/index', description: '每日一句名人名言·收藏复制' },
  { id: 'miteguide', name: '螨虫指南', category: 'life', icon: '🔍', path: '/packages/toolsA/miteguide/index', description: '除螨方法·螨虫类型·预防指南' },
  { id: 'flowerlang', name: '花语图鉴', category: 'life', icon: '🌸', path: '/packages/toolsA/flowerlang/index', description: '55种花语查询·送花场景推荐' },
  { id: 'acupoint', name: '穴位图谱', category: 'life', icon: '📍', path: '/packages/toolsA/acupoint/index', description: '常见穴位查询·按摩养生指南' },
  { id: 'answerbook', name: '答案之书', category: 'fun', icon: '📖', path: '/packages/toolsB/answerbook/index', description: '心中想问题·翻开答案之书解惑' },
  { id: 'coloring', name: '涂色本', category: 'fun', icon: '🎨', path: '/packages/toolsA/coloring/index', description: '创意填色·放松解压·作品保存' },
  ...
  { id: 'math27', name: '算27点', category: 'study', icon: '🎯', path: '/packages/toolsA/math27/index', description: '4个数字算出27·数学运算训练' },
  { id: 'pinyin-learn', name: '拼音学习', category: 'study', icon: '🅰️', path: '/packages/toolsB/pinyin-learn/index', description: '声母韵母整体认读·发音练习·声调标注' },
  { id: 'alpha-learn', name: '英语字母卡', category: 'study', icon: '🔤', path: '/packages/moreTools/alpha-learn/index', description: '26个字母学习·大小写配对·首字母练习' },
  { id: 'focus-game', name: '专注力互动', category: 'study', icon: '🎯', path: '/packages/moreTools/focus-game/index', description: '舒尔特方格·找不同·颜色干扰·记忆翻牌' },
  { id: 'stacking', name: '叠叠乐', category: 'fun', icon: '🏗️', path: '/packages/toolsA/stacking/index', description: '方块下落对齐·越高越难·完美连击加分' },
  { id: 'cardmatch', name: '翻牌配对', category: 'fun', icon: '🃏', path: '/packages/toolsB/cardmatch/index', description: '翻转卡牌找到相同图案·计时计步·难度递增' },
  { id: 'pomodoro', name: '番茄钟', category: 'life', icon: '🍅', path: '/packages/toolsB/pomodoro/index', description: '25分钟专注+5分钟休息·白噪音·每日统计' },
  { id: 'lifecalendar', name: '人生日历', category: 'life', icon: '📅', path: '/packages/toolsB/lifecalendar/index', description: '输入生日·可视化已过/剩余周数·珍惜时间' },
  { id: 'dynasty', name: '历史朝代表', category: 'study', icon: '📜', path: '/packages/moreTools/dynasty/index', description: '中国历史朝代时间轴·排序互动·历史问答' },
  { id: 'geo-quiz', name: '地理知识问答', category: 'study', icon: '🌍', path: '/packages/moreTools/geo-quiz/index', description: '中国地理·世界地理·随机10题·知识挑战' },
  { id: 'tang-poetry', name: '唐诗三百首', category: 'study', icon: '📖', path: '/packages/moreTools/tang-poetry/index', description: '唐诗背诵·填空练习·赏析学习' },
  { id: 'math-formulas', name: '数学公式大全', category: 'study', icon: '📐', path: '/packages/moreTools/math-formulas/index', description: '小学到高中数学公式速查·搜索收藏' },
  { id: 'cal-wallpaper', name: '日历壁纸', category: 'image', icon: '📅', path: '/packages/imgTools/cal-wallpaper/index', description: '选图片+当月日历生成手机壁纸·保存到相册' },
  { id: 'onestroke', name: '一笔画', category: 'fun', icon: '✏️', path: '/packages/toolsB/onestroke/index', description: '数学逻辑一笔画·欧拉路径·关卡挑战' },
  { id: 'periodic-table', name: '元素周期表', category: 'study', icon: '⚛️', path: '/packages/moreTools/periodic-table/index', description: '化学元素周期表·搜索·分类筛选·详细信息' },
  { id: 'daily-photo', name: '每日一拍', category: 'life', icon: '📸', path: '/packages/toolsB/daily-photo/index', description: '每天拍一张照片·日历回顾·时光轴·连续打卡' },
  { id: 'typing-test', name: '打字速度', category: 'study', icon: '⌨️', path: '/packages/moreTools/typing-test/index', description: '测试打字速度WPM·准确率统计·三种难度' },
  { id: 'text2img', name: '文字转图片', category: 'image', icon: '📝', path: '/packages/imgTools/text2img/index', description: '输入文字生成精美长图·8种模板·适合发朋友圈' },
  { id: 'imgmerge', name: '图片拼接', category: 'image', icon: '🧩', path: '/packages/imgTools/imgmerge/index', description: '多张图片上下/左右拼接成长图·保存到相册' },
  ...
  { id: 'codeblock', name: '编程启蒙', category: 'study', icon: '🤖', path: '/packages/toolsA/codeblock/index', description: '拖拽指令块控制角色移动·图形化编程启蒙' },
  { id: 'numberbomb', name: '数字炸弹', category: 'fun', icon: '💣', path: '/packages/toolsB/numberbomb/index', description: '轮流点数字·谁点中藏起来的炸弹谁就爆炸·聚会必备' },
  { id: 'dontpress', name: '别按这个按钮', category: 'fun', icon: '🚫', path: '/packages/toolsB/dontpress/index', description: '各种诱惑按钮·忍住不按·坚持越久分越高·反直觉挑战' },
  { id: 'reverse', name: '反着来', category: 'fun', icon: '🙃', path: '/packages/toolsA/reverse/index', description: '屏幕让你点左你偏点右·反向反应挑战·连击计分' },
  { id: 'balancebeam', name: '平衡木', category: 'fun', icon: '⚖️', path: '/packages/toolsA/balancebeam/index', description: '左右倾斜手机·保持小球在木条上不掉落·坚持越久分越高' },
  { id: 'grabcolor', name: '抢颜色', category: 'fun', icon: '🌈', path: '/packages/toolsA/grabcolor/index', description: '斯特鲁普效应·字义和颜色打架·两人抢点正确颜色·手快脑稳者胜' },
