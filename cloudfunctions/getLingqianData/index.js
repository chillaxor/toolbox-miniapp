...
const POEMS_DATA = [
  ...
  { title: '江南逢李龟年', author: '杜甫', dynasty: '唐', lines: ['岐王宅里寻常见', '崔九堂里几度闻', '正是江南好风景', '落花时节又逢君'] },
  ...
  { title: '泊船瓜洲', author: '王安石', dynasty: '宋', lines: ['京口瓜洲一水间', '钟山只隔几重山', '春风又绿江南岸', '明月何时照我还'] },
...
exports.main = async (event, context) => {
  try {
    ...
    // 同时返回签文数据和诗词数据
    return { LINGQIAN_DATA, POEMS_DATA }
  } catch (error) {
